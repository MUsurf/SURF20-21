###########################################################################
## Makefile generated for component 'cCode'. 
## 
## Makefile     : cCode.mk
## Generated on : Tue Nov 30 15:58:10 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/cCode
...
START_DIR                 = /Users/dante/Desktop/MatLab/Surf
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/cCode
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/cCode_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=cCode -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/cCode_grt_rtw/cCode.c $(START_DIR)/cCode_grt_rtw/cCode_data.c $(START_DIR)/cCode_grt_rtw/rtGetInf.c $(START_DIR)/cCode_grt_rtw/rtGetNaN.c $(START_DIR)/cCode_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.o cCode.o cCode_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/cCode_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/cCode_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
cCode.o : $(START_DIR)/cCode_grt_rtw/cCode.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cCode_data.o : $(START_DIR)/cCode_grt_rtw/cCode_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/cCode_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/cCode_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/cCode_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
